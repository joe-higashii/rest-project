...
import com.thinkproject.rest_project.config.documentation.AuthControllerApiOperation.*;
...
public class AuthController {
    ...
    public String register(@Valid @RequestBody CreateUserRequest request) {
    ...
    public LoginResponseDTO renewToken(@RequestHeader("Authorization") String token) {
